...
public class BitManipulation {
  ...
  /**
   * Use mask bits to clear, then set
   * 
   * @param id     encoded id
  ...
  public static void main(String[] args) {
    ...
    BitManipulation solution = new BitManipulation();
    long id = solution.encodeId(2, 7, 15);
    System.out.println(id);
    System.out.println(solution.printBits(id));
    System.out.println(Arrays.toString(solution.decodeId(id)));
