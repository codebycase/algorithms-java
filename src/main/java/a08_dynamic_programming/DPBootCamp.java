...
public class DPBootCamp {
     ...
     * move the ball to adjacent cell or cross the grid boundary in four directions (up, down, left,
     * right). However, you can at most move N times. Find out the number of paths to move the ball
     * out of grid boundary. The answer may be very large, return it after mod 10^9 + 7.
     */
    int M = 1000000007;
