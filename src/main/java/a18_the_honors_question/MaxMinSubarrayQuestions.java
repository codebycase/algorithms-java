...
public class MaxMinSubarrayQuestions {
	...
	/**
	 * Given an array of positive integers numbers. Count and print the number of (contiguous)
	 ...
	 * 
	 * For example, if A = [1,3,5,4,7], The longest continuous increasing subsequence is [1,3,5],
	 * its length is 3.
	 */
	 ...
	 * array has a continuous subarray of size at least 2 that sums up to the multiple of k, that
	 * is, sums up to n*k where n is also an integer.
	 * 
	 * For example: if A = [1, 23, 2, 6, 4, 7, 9] and k = 6, because [23, 2, 6, 4, 7] is an
	 * continuous subarray of size 5 and sums up to 42, which is the multiple of 6.
	 */
	 ...
	 * range.
	 * 
	 * Example 1: Given nums = [1, -1, 5, -2, 3], k = 3, return 4. (because the subarray [1, -1, 5,
