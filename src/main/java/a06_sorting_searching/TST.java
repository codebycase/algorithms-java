 ...
 * {@link java.util.Map}, this class uses the convention that values cannot be {@code null}—setting
 * the value associated with a key to {@code null} is equivalent to deleting the key from the symbol
 * table.
 * <p>
